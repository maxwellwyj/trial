      ...
      <el-container class="container">
        ...
        <el-scrollbar>
          <el-table :data="filteredData">
            ...
            <el-table-column prop="crackSize" label="Crack Size"></el-table-column>
            <el-table-column prop="damageLevel" label="Damage Level"></el-table-column>
          </el-table>
        </el-scrollbar>
      </el-main>
      </el-container>
...
const filteredData = ref<fileData[]>([]);
  ...
  try {
    const response = await axios.get<any>('http://localhost:5173/map/case1data.json');
